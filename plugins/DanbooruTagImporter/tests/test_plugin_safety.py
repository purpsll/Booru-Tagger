...
class PluginSafetyTests(unittest.TestCase):
    ...
    def test_legacy_tuning_settings_cannot_override_fixed_policy(self):
        ...
        self.assertEqual(review, 90.0)
        self.assertFalse(accept)

    def test_saucenao_confidence_bands(self):
        self.assertEqual(plugin._visual_confidence(96.0, 95.0, 90.0), "HIGH")
        self.assertEqual(plugin._visual_confidence(94.0, 95.0, 90.0), "REVIEW")
        self.assertEqual(plugin._visual_confidence(89.9, 95.0, 90.0), "LOW")
